...
import com.danielvilha.gdgfinder.databinding.FragmentGdgListBinding
...
class GdgListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_gdg_list, container, false)
